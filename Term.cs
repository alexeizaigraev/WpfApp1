...
namespace WpfApp1
{
    class Term : PapaSome
    {
        ...
        public static int MainTerm()
        {
            outLine = "";
            outText = "";
            string inFileName = "vsyo_zapros_vnesh_otbor.csv";
            ...
            foreach (string key in data.Keys)
            {
                ...
                if (serial0 == "") serial = dictLine["fiscal_number"];
                else serial = serial0.Substring(startZero + 1, serial0.Length - startZero - 1);
